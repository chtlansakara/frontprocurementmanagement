...
@Component({
  selector: 'app-admindiv-procurement-report',
  standalone: false,
  templateUrl: './admindiv-procurement-report.component.html',
  styleUrl: './admindiv-procurement-report.component.scss'
})
export class AdmindivProcurementReportComponent {
      //form-group
  ...
  submitReportForm(){
    ...
    this.admindivService.downloadAdmindivProcurementReport(formattedStart, formattedEnd, format).subscribe((blob: Blob)=>{
