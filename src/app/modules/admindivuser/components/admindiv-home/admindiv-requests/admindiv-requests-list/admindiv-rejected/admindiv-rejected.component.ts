...
@Component({
  selector: 'app-admindiv-rejected',
  standalone: false,
  templateUrl: './admindiv-rejected.component.html',
  styleUrl: './admindiv-rejected.component.scss'
})
export class AdmindivRejectedComponent {
  ...
  loadList(){
    this.admindivService.getRejectedRequests().subscribe(res => {
