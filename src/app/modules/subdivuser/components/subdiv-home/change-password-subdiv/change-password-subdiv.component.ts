...
@Component({
  selector: 'app-change-password-subdiv',
  standalone: false,
  templateUrl: './change-password-subdiv.component.html',
  styleUrl: './change-password-subdiv.component.scss'
})
export class ChangePasswordSubdivComponent {
