...
@Component({
  selector: 'app-user-update-subdiv',
  standalone: false,
  templateUrl: './user-update-subdiv.component.html',
  styleUrl: './user-update-subdiv.component.scss'
})
export class UserUpdateSubdivComponent {
   //form-group
